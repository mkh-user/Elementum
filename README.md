...
Share your creations on [ElementumHost](https://github.com/mkh-user/ElementumHost) by creating an issue using the "Upload Element" template ([fast link](https://github.com/mkh-user/ElementumHost/issues/new?template=upload-element.md)). Once approved, your element will be added, and the elements list will update. Please note that updates may take up to an hour to sync perfectly due to a minor display glitch.
